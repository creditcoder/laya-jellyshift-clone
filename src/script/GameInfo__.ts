export default class GameInfo {
    ...
    public static models = [
        {"idx":1, "name":"blue_guy", "category":"jelly", "sub_category":"jelly", "active":true, "color":"#1b6efa"}
        , {"idx":2, "name":"bright_blue_girl", "category":"jelly", "sub_category":"jelly", "active":false, "color":"#1efefd"}
        , {"idx":3, "name":"green_guy", "category":"jelly", "sub_category":"jelly", "active":false, "color":"#7df81a"}
        , {"idx":4, "name":"pink_girl", "category":"jelly", "sub_category":"jelly", "active":false, "color":"#e175ff"}
        , {"idx":5, "name":"red_guy_cube", "category":"jelly", "sub_category":"jelly", "active":false, "color":"#fa246d"}
        , {"idx":6, "name":"yellow_guy", "category":"jelly", "sub_category":"jelly", "active":false, "color":"#fbe21c"}
        
        , {"idx":7, "name":"Bear", "category":"animals", "sub_category":"animals1", "active":false, "color":"#dc7126"}
        , {"idx":8, "name":"Cat", "category":"animals", "sub_category":"animals1", "active":false, "color":"#718ad4"}
        , {"idx":9, "name":"Cheetah", "category":"animals", "sub_category":"animals1", "active":false, "color":"#ffc83c"}
        , {"idx":10, "name":"Cock", "category":"animals", "sub_category":"animals1", "active":false, "color":"#e70503"}
        , {"idx":11, "name":"Dog", "category":"animals", "sub_category":"animals1", "active":false, "color":"#9d8674"}
        , {"idx":12, "name":"Duck", "category":"animals", "sub_category":"animals1", "active":false, "color":"#55d044"}
        , {"idx":13, "name":"Fox", "category":"animals", "sub_category":"animals2", "active":false, "color":"#ff7f04"}
        , {"idx":14, "name":"Frog", "category":"animals", "sub_category":"animals2", "active":false, "color":"#7bdb21"}
        , {"idx":15, "name":"Hippo", "category":"animals", "sub_category":"animals2", "active":false, "color":"#7fc9fb"}
        , {"idx":16, "name":"Lion", "category":"animals", "sub_category":"animals2", "active":false, "color":"#ffd83c"}
        , {"idx":17, "name":"Owl", "category":"animals", "sub_category":"animals2", "active":false, "color":"#e4aaf4"}
        , {"idx":18, "name":"Penguin", "category":"animals", "sub_category":"animals2", "active":false, "color":"#263e9a"}
        , {"idx":19, "name":"Pig", "category":"animals", "sub_category":"animals2", "active":false, "color":"#fd8ab2"}
        , {"idx":20, "name":"Racoon", "category":"animals", "sub_category":"animals2", "active":false, "color":"#475068"}
        , {"idx":21, "name":"Sheep", "category":"animals", "sub_category":"animals2", "active":false, "color":"#d4e7e6"}
    
        , {"idx":22, "name":"BadGuy", "category":"heroes", "sub_category":"heroes", "active":false, "color":"#dc7126"}
        , {"idx":23, "name":"CaptainAmerica", "category":"heroes", "sub_category":"heroes", "active":false, "color":"#dc7126"}
        , {"idx":24, "name":"Cowboy", "category":"heroes", "sub_category":"heroes", "active":false, "color":"#dc7126"}
        , {"idx":25, "name":"Deadpool", "category":"heroes", "sub_category":"heroes", "active":false, "color":"#dc7126"}
        , {"idx":26, "name":"IronMan", "category":"heroes", "sub_category":"heroes", "active":false, "color":"#dc7126"}
        , {"idx":27, "name":"Magician", "category":"heroes", "sub_category":"heroes", "active":false, "color":"#dc7126"}
        , {"idx":28, "name":"PinkGuy", "category":"heroes", "sub_category":"heroes", "active":false, "color":"#dc7126"}
        , {"idx":29, "name":"Princess", "category":"heroes", "sub_category":"heroes", "active":false, "color":"#dc7126"}
        , {"idx":30, "name":"Robin", "category":"heroes", "sub_category":"heroes", "active":false, "color":"#dc7126"}
        // , {"idx":31, "name":"Snarglius", "category":"heroes", "sub_category":"heroes", "active":false, "color":"#dc7126"}
    
        , {"idx":31, "name":"Coala", "category":"legendary", "sub_category":"legendary", "active":false, "color":"#dc7126"}
        , {"idx":32, "name":"CommandoTiger", "category":"legendary", "sub_category":"legendary", "active":false, "color":"#dc7126"}
        , {"idx":33, "name":"Cow", "category":"legendary", "sub_category":"legendary", "active":false, "color":"#dc7126"}
        , {"idx":34, "name":"Crock", "category":"legendary", "sub_category":"legendary", "active":false, "color":"#dc7126"}
        , {"idx":35, "name":"Lama", "category":"legendary", "sub_category":"legendary", "active":false, "color":"#dc7126"}
        , {"idx":36, "name":"Panda", "category":"legendary", "sub_category":"legendary", "active":false, "color":"#dc7126"}
        , {"idx":37, "name":"Rabbit", "category":"legendary", "sub_category":"legendary", "active":false, "color":"#dc7126"}
        , {"idx":38, "name":"Shark", "category":"legendary", "sub_category":"legendary", "active":false, "color":"#dc7126"}
        , {"idx":39, "name":"Sloth", "category":"legendary", "sub_category":"legendary", "active":false, "color":"#dc7126"}
    ];
    ...
    public static resArray:Array<string>=[
    ...
    public static GetTerrainInfo() {
        GameInfo.terrainNum = GameInfo.round % 5;
        if (GameInfo.terrainNum == 0)
            GameInfo.terrainNum = 5;
    ...
    public static IsJewlsLevel():Boolean {
        ...
        return false;//GameInfo.isJewlsRound;
    }
    ...
    public static getSkyColor():Laya.Vector4 {
        ...
        let arr = ["#00ff00", "#0000ff", "#ffff00", "#00ffff", "#ff00ff","#ff0000"];
        //let cl = Math.floor(Math.random()*6);
        //console.log(cl);
        return this.calcRGB(arr[GameInfo.round % 6]);
    }

(function () {
	...
	(function (ui) {
	    ...
	    SettingSceneUI.uiView = { "type": "Dialog", "props": { "zOrder": 0, "width": 412, "runtime": "script/SettingDlg.ts", "renderType": "render", "isShowEffect": true, "isPopupCenter": true, "isModal": true, "hitTestPrior": true, "height": 732 }, "compId": 2, "child": [{ "type": "Sprite", "props": { "zOrder": -1, "y": 298, "x": 459, "width": 371, "texture": "Images/popup.png", "pivotY": 242, "pivotX": 439, "height": 504 }, "compId": 10 }, { "type": "Button", "props": { "y": 596, "x": 91, "width": 232, "var": "btn_back", "stateNum": 1, "scaleY": 1, "scaleX": 1, "name": "close", "labelSize": 35, "labelFont": "Arial", "labelColors": "white", "height": 91 }, "compId": 11 }, { "type": "CheckBox", "props": { "y": 155, "x": 222.5, "width": 249, "var": "chk_haptic", "stateNum": 2, "skin": "Images/checkbox.png", "scaleY": 0.5, "scaleX": 0.5, "name": "chk_haptic", "height": 98 }, "compId": 14 }, { "type": "CheckBox", "props": { "y": 232.5, "x": 222.5, "var": "chk_sound", "stateNum": 2, "skin": "Images/checkbox.png", "scaleY": 0.5, "scaleX": 0.5, "name": "chk_sound" }, "compId": 15 }, { "type": "Label", "props": { "y": 165, "x": 73, "width": 119, "text": "HAPTIC", "height": 39, "fontSize": 30, "font": "Arial" }, "compId": 16 }, { "type": "Label", "props": { "y": 245, "x": 73, "width": 115, "text": "SOUND", "height": 36, "fontSize": 30, "font": "Arial" }, "compId": 17 }, { "type": "Label", "props": { "y": 65, "x": 133, "width": 158, "text": "SETTINGS", "height": 37, "fontSize": 30, "font": "Arial", "color": "white" }, "compId": 18 }, { "type": "Button", "props": { "y": 330, "x": 63, "width": 135, "stateNum": 1, "skin": "Images/settings_menu_frame.png", "labelSize": 15, "labelFont": "Arial", "label": "RESTORE\\nPURCHASES", "height": 60 }, "compId": 21 }, { "type": "Button", "props": { "y": 331, "x": 225, "width": 135, "stateNum": 1, "skin": "Images/settings_menu_frame.png", "labelSize": 15, "labelFont": "Arial", "label": "WETHDRAW\\nCONSENT", "height": 60 }, "compId": 22 }, { "type": "Button", "props": { "y": 429, "x": 77.5, "width": 259, "stateNum": 1, "skin": "Images/ads.png", "labelSize": 20, "labelFont": "Arial", "labelColors": "white", "label": "        REMOVE ADS", "height": 85 }, "compId": 27 }, { "type": "Sprite", "props": { "y": 596, "x": 91, "width": 232, "texture": "Images/back.png", "height": 91 }, "compId": 28, "child": [{ "type": "Label", "props": { "y": 25.5, "x": 39.310546875, "text": "    BACK", "fontSize": 40, "font": "arial", "color": "white" }, "compId": 29 }] }], "loadList": ["Images/popup.png", "Images/checkbox.png", "Images/settings_menu_frame.png", "Images/ads.png", "Images/back.png"], "loadList3D": [] };
	...
	class Food extends Laya.Script3D {
	    ...
	    updateGameInfo() {
	        ...
	        let maxlen = GameInfo$1.getTerrainLength(round);
	        ...
	        for (let i = 0; i < shader_obs_list.numChildren - 1; i++) {
	            ...
	            if (shader_obs_tmp) {
	                for (var s = 0; s < shader_obs_tmp.numChildren - 1; s++) {
	                    shader_obs_tmp.getChildAt(s).meshRenderer.castShadow = true;
	                }
